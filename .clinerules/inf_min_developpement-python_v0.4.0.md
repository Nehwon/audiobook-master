...
- Maintain a TODO.md file describing the tasks done, doing and todo. When a task is changing status, correct this file IN PRIORITY.
- Maintain a ROADMAP.md with Milestones and goals.
...
Bonnes pratiques de développement Python pour les projets Earth-2xxx. Applicable lors de la création de scripts et applications Python, assurant qualité et maintenabilité du code.

**Version : 0.4.0** | **Catégorie : Informatique/Développement/Python**
